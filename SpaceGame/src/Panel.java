 ...
 * the given statistics for the player. (See the render() method.) */
public class Panel {
/* The class variables */
...
/* The class methods */
     ...
     * @param firepower The player's current fire-power level. */
    public void render(Graphics g, int shield, int full_shield, int firepower) {
        // Panel colors
        Color LABEL = new Color(0.9f, 0.9f, 0.4f);          // Gold
        Color VALUE = new Color(1.0f, 1.0f, 1.0f);          // White
        Color BAR_BG = new Color(0.0f, 0.0f, 0.0f, 0.6f);   // Black, transparent
        Color BAR_FS = new Color(1.0f, 0.3f, 0.3f, 0.05f);  // Red, transparent
        ...
        int fp_x, fp_y;             // Coordinates to draw fire-power
        ...
        // Display the player's fire-power
        g.setColor(LABEL);
